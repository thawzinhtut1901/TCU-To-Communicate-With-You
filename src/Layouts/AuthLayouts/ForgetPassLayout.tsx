...
const ForgetPassLayout = () => {
  ...
  return (
    <div className="bg-custom-gradient w-full h-screen overflow-hidden">
        ...
        <div onClick={() => navigate("/")} className="absolute flex justify-start items-center md:hidden" style={{ top: '50%', transform: 'translateY(-50%)' }}>
          <AiOutlineLeft className="w-[24px] h-[24px] text-white"/>
        </div>
