...
import { useGetAllSuggestedFri } from "@/hooks";
                  ...
                  <div  className="flex mt-[12px] md:mt-[18px]">
                    ...
                    <div className="flex flex-col mx-auto font-poppins">
                      ...
                      <div className="flex gap-x-4 mt-1">
                        <Button className="bg-blue-600 hover:bg-blue-500 rounded-[8px] w-[100px] h-[30px] md:h-[40px] text-[12px] text-white hover:text-slate-100"><BsPlusLg className="mr-2 w-[14px] h-[14px]"/> Add</Button>
