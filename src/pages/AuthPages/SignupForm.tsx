...
const SignupForm = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen gap-3">
      <h2 className="flex justify-center text-2xl font-medium text-white font-poppins">
        Sign in
      </h2>
      ...
      <div className="flex space-x-2 mx-auto mt-[40px] w-[550px] justify-center items-start font-poppins font-thin text-white">
        <Checkbox id="recieve-email" className="rounded-[5px]" />
        <Label htmlFor="recieve-email" className="cursor-pointer">
      ...
      <h2 className="flex mx-auto mt-[24px] w-[550px] font-poppins font-thin text-[14px] text-white">
        By creating an account, you agree to the{" "}
        <a href="#" className="pl-1 border-b">
          {" "}
      ...
      <Button
        ...
        type="submit"
        className="flex bg-slate-50 hover:bg-slate-300 my-3 border rounded-full font-poppins font-thin text-[#8566FF] text-[14px]"
      >
        Create An Account
      </Button>

      <h2 className="flex font-poppins font-thin text-[14px] text-white">
