...
const RelationPage = () => {
  return (
    <div className="flex justify-center w-screen h-screen">
      <div className="flex flex-col bg-white bg-opacity-40 rounded-[10px] w-[80%] h-[750px]">
        <div className="flex justify-center mt-3 mb-[35px]">
          <h1 className="font-poppins font-medium text-[26px]">Relationship</h1>
        </div>
