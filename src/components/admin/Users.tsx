...
const Users = () => {
  ...
  return(
    <div className="flex flex-col mx-auto w-11/12 overflow-auto scrollbar-hide">
      ...
      <div className="bg-white shadow-custom-grey-inner mt-[24px] rounded-[8px] w-full max-w-[90rem] cursor-pointer">
...

        {
          getAccounts?.items.map((user:any) => (
            <ul key={user?.id} id={user?.id} className="items-center gap-x-8 grid grid-cols-10 py-[15px] border-b border-b-slate-400 font-roboto text-[14px] text-center"> 
