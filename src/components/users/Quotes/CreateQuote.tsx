...
const CreateQuote = () => {
  ...
  return (
    <div className="flex flex-col w-full font-poppins">
        <div className="flex flex-col border-slate-500 bg-black bg-opacity-20 mx-auto mt-[16px] border rounded-[8px] w-11/12 h-[200px]">
            <h2 className="mt-[25px] text-center text-white">Share your thoughts with the world—create your own quotes and inspire others today!</h2>
            
            <form onSubmit={handleQuoteSubmit} className="flex flex-col">
                <div className="relative mx-auto mt-[15px] w-full max-w-sm md:max-w-md">
                    ...
                    <input 
                        ...
                        className="border-white bg-[#007AFF] bg-opacity-10 shadow-md shadow-slate-400 mt-1 md:mt-2 px-2 md:px-4 py-1 md:py-2 border rounded-[8px] w-[450px] h-[45px] text-[12px] text-center text-slate-50 md:text-[16px] cursor-text"
                    />
                </div>

                <button type="submit" className="bg-black bg-opacity-30 hover:bg-opacity-20 shadow-md shadow-slate-400 mx-auto mt-[23px] rounded-[16px] w-[150px] h-[40px] text-[16px] text-white hover:text-slate-200">
                    Create Quote
                </button>
            </form>
        ...
        <div className="flex border-slate-500 bg-black bg-opacity-20 mx-auto mt-[22px] border rounded-[8px] w-11/12 h-full max-h-[40vh] overflow-auto scrollbar-hide">
            <Table>
